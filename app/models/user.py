from sqlalchemy import Boolean, Column, String, BigInteger, DateTime, func, CheckConstraint, ForeignKey, Integer
...
class Users(Base):
    ...
    token = relationship("TokenStore", back_populates="user", uselist=False, cascade="all, delete-orphan")
